...
BestInPlaceEditor.prototype = {
  ...
  initOptions : function() {
    ...
    // ADAM - Pass the object id as additional data in the POST request if the update is being made through a foreign controller
      self.objectId      = self.objectId      || $parent.attr("data-model-id");
    });
  ...
  // ADAM
    self.objectId      = self.element.attr("data-model-id")      || self.objectId;
  ...
  // ADAM - Add the id of the object(rails model) into the POST request only if it is defined
